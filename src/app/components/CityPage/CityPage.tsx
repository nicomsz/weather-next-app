    ...
    <>
      ...
      {!apiSuccess ? (
        ...
        <div className="z-[-1] flex h-screen flex-row items-center justify-center">
          <Background />
          <div className="absolute z-10 mx-auto w-[350px] rounded-[30px] p-10 md:w-[450px] lg:h-[800px] lg:w-[450px]">
            <AppBg />
            <div className="mx-auto flex w-fit items-center justify-center p-2 ">
              <div className="mx-auto flex flex-col justify-center gap-10 rounded-[30px] text-white lg:pt-16">
                <motion.div
                  className={`h-[270px] w-full rounded-2xl border-[0.3px] border-gray-300 p-4 backdrop-blur-[80px] lg:h-[420px] lg:p-6`}
                  onClick={() => setAnimar(!animar)}
                  ref={animatedDiv}
                  animate={
                    animar
                      ? { height: height + 220, marginTop: 50 }
                      : {
                          scale: 1,
                          height,
                        }
                ...
                >
                  <div className="flex flex-wrap justify-between">
                    <div
                      className={`${montserrat300.className} text-sm lg:text-lg`}
                    >
                      {/* Localização */}
                    ...
                    <div className="flex w-full justify-between pt-2">
                      <div className={montserrat300.className}>
                        ...
                        <div className="flex flex-row gap-3 pl-1 pt-1 ">
                          <div className="absolute h-[20px] w-[15px] lg:h-[30px] lg:w-[30px]">
                            <Image
                          ...
                          <div>
                            <p className=" ml-7 text-sm lg:ml-10 lg:text-xl">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[16.3px] lg:text-[13px]">
                        Rain chance
                      </p>
                      <p className="text-[14px] text-white lg:text-xl">
                ...
                >
                  <ul className="flex flex-wrap content-center items-center justify-center gap-2 text-center md:gap-5   lg:gap-4">
